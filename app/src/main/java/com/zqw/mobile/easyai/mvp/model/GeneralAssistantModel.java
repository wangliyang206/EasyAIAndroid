 ...
 */
@ActivityScope
public class GeneralAssistantModel extends BaseModel implements GeneralAssistantContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GeneralAssistantModel(IRepositoryManager repositoryManager) {
